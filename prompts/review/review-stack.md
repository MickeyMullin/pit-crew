...
- **"approve" still posts automatically.** It is a durable record that the stack was reviewed and found sound, it does not go stale the way a findings list does, and there is nothing in it for the author to respond to first.
